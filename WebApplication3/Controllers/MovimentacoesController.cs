...
namespace WebApplication3.Controllers
{
    public class MovimentacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MovimentacaoId,ProdutoId,Quantidade,Descricao,Datamovimentacao")] Movimentacao movimentacao)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "ProdutoId", "ProdutoId", movimentacao.ProdutoId);
            return View(movimentacao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovimentacaoId,ProdutoId,Quantidade,Descricao,Datamovimentacao")] Movimentacao movimentacao)
        {
